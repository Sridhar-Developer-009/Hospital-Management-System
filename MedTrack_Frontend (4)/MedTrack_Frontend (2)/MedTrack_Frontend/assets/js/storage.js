...
(function() {
  const StorageDB = {
    init: function() {
      if (!localStorage.getItem('medtrack_version')) {
        ...
        localStorage.setItem('medtrack_version', '2');
      }
  ...
  StorageDB.seedPatientData = function() {
    ...
    const patients = [
      { id:'PAT-1001', name:'Arun Sharma', age:45, gender:'Male', contact:'9876543210', email:'arun.s@email.com', bloodGroup:'O+', department:'Cardiology', assignedDoctor: DOCTORS[0], address:'12, Lake View Road, Chennai', emergencyContact:'9876543001', medicalHistory:'Hypertension since 2023. No allergies.', status:'ACTIVE', registeredAt:'2026-01-15T10:30:00Z', dateOfBirth:'1981-05-20', username:'arun_s', password:'Patient@123' },
      { id:'PAT-1002', name:'Lakshmi Narayanan', age:32, gender:'Female', contact:'9876543211', email:'lakshmi.n@email.com', bloodGroup:'B+', department:'General Medicine', assignedDoctor: DOCTORS[2], address:'45, MG Nagar, Bangalore', emergencyContact:'9876543002', medicalHistory:'Type 2 diabetes (2024).', status:'ACTIVE', registeredAt:'2026-02-03T14:15:00Z', dateOfBirth:'1994-08-12', username:'lakshmi_n', password:'Patient@123' },
      { id:'PAT-1003', name:'Venkatesh Rao', age:58, gender:'Male', contact:'9876543212', email:'venky.r@email.com', bloodGroup:'A-', department:'Orthopaedics', assignedDoctor: DOCTORS[3], address:'8, Nehru Street, Hyderabad', emergencyContact:'9876543003', medicalHistory:'Knee replacement (2022). Arthritis.', status:'FOLLOWUP', registeredAt:'2026-01-20T09:00:00Z', dateOfBirth:'1968-11-03', username:'venkatesh_r', password:'Patient@123' },
      { id:'PAT-1004', name:'Priya Karthikeyan', age:29, gender:'Female', contact:'9876543213', email:'priya.k@email.com', bloodGroup:'AB+', department:'Dermatology', assignedDoctor: DOCTORS[1], address:'23, East Coast Road, Puducherry', emergencyContact:'9876543004', medicalHistory:'Eczema. Allergic to sulfa drugs.', status:'ACTIVE', registeredAt:'2026-03-10T11:45:00Z', dateOfBirth:'1997-07-18', username:'priya_k', password:'Patient@123' },
      { id:'PAT-1005', name:'Rajan Menon', age:62, gender:'Male', contact:'9876543214', email:'rajan.m@email.com', bloodGroup:'O-', department:'Cardiology', assignedDoctor: DOCTORS[0], address:'67, Marine Drive, Kochi', emergencyContact:'9876543005', medicalHistory:'Coronary artery disease. Stent placed 2023.', status:'INPATIENT', registeredAt:'2026-04-01T08:00:00Z', dateOfBirth:'1964-02-28', username:'rajan_m', password:'Patient@123' },
      { id:'PAT-1006', name:'Divya Nair', age:8, gender:'Female', contact:'9876543215', email:'divya.n@email.com', bloodGroup:'B-', department:'Paediatrics', assignedDoctor: DOCTORS[4], address:'5, Temple Street, Madurai', emergencyContact:'9876543006', medicalHistory:'Asthma. Allergic to peanuts.', status:'ACTIVE', registeredAt:'2026-03-22T16:30:00Z', dateOfBirth:'2018-06-14', username:'divya_n', password:'Patient@123' },
      ...
      { id:'PAT-1008', name:'Anitha Joseph', age:36, gender:'Female', contact:'9876543217', email:'anitha.j@email.com', bloodGroup:'O+', department:'Cardiology', assignedDoctor: DOCTORS[6], address:'89, Church Road, Kottayam', emergencyContact:'9876543008', medicalHistory:'Mitral valve prolapse. Routine checkup.', status:'FOLLOWUP', registeredAt:'2026-04-05T10:15:00Z', dateOfBirth:'1990-03-11', username:'anitha_j', password:'Patient@123' },
      { id:'PAT-1009', name:'Ganesh Iyer', age:55, gender:'Male', contact:'9876543218', email:'ganesh.i@email.com', bloodGroup:'AB-', department:'Orthopaedics', assignedDoctor: DOCTORS[7], address:'101, Gandhi Nagar, Salem', emergencyContact:'9876543009', medicalHistory:'Lumbar spondylosis. Physiotherapy ongoing.', status:'ACTIVE', registeredAt:'2026-01-30T09:30:00Z', dateOfBirth:'1971-12-05', username:'ganesh_i', password:'Patient@123' },
      { id:'PAT-1010', name:'Meenalochini Devi', age:27, gender:'Female', contact:'9876543219', email:'meena.d@email.com', bloodGroup:'B+', department:'Dermatology', assignedDoctor: DOCTORS[8], address:'56, North Car Street, Tirunelveli', emergencyContact:'9876543010', medicalHistory:'Acne vulgaris. Skin sensitivity.', status:'ACTIVE', registeredAt:'2026-04-12T15:45:00Z', dateOfBirth:'1999-01-22', username:'meena_d', password:'Patient@123' },
  ...
  StorageDB.DEFAULT_AUDIT_LOGS = [
    { id:'AUDIT-1', ts:'2026-07-03 09:45:12', user:'Admin', action:'Login', resource:'System', details:'Successful login from admin console', severity:'Info' },
    { id:'AUDIT-2', ts:'2026-07-03 09:30:05', user:'Dr. Sarah Chen', action:'Update', resource:'Schedule', details:'Updated availability for Jul 2026', severity:'Info' },
    { id:'AUDIT-3', ts:'2026-07-03 08:15:42', user:'System', action:'Backup', resource:'Database', details:'Nightly backup completed (1.2 GB)', severity:'Info' },
    { id:'AUDIT-4', ts:'2026-07-02 17:00:00', user:'Admin', action:'Logout', resource:'System', details:'Session ended', severity:'Info' },
    { id:'AUDIT-5', ts:'2026-07-02 16:45:32', user:'HR Dept', action:'Create', resource:'Staff', details:'Added new staff record — Dr. Lisa Wang', severity:'Info' },
    { id:'AUDIT-6', ts:'2026-07-02 15:20:18', user:'Dr. Mark Thompson', action:'Login', resource:'System', details:'Failed login attempt (wrong password)', severity:'Warning' },
    { id:'AUDIT-7', ts:'2026-07-02 14:00:09', user:'System', action:'Error', resource:'EMR Sync', details:'EMR integration timeout — retrying', severity:'Error' },
    { id:'AUDIT-8', ts:'2026-07-02 11:30:27', user:'Admin', action:'Export', resource:'Reports', details:'Exported Revenue Report (PDF)', severity:'Info' },
    { id:'AUDIT-9', ts:'2026-07-01 22:00:00', user:'System', action:'Backup', resource:'Database', details:'Nightly backup completed (1.1 GB)', severity:'Info' },
    { id:'AUDIT-10', ts:'2026-07-01 18:30:15', user:'Dr. Emily Park', action:'Login', resource:'System', details:'Successful login from 10.0.0.45', severity:'Info' },
    { id:'AUDIT-11', ts:'2026-07-01 14:20:00', user:'Admin', action:'Update', resource:'Settings', details:'Updated system notification preferences', severity:'Info' },
    { id:'AUDIT-12', ts:'2026-07-01 10:10:10', user:'HR Dept', action:'Delete', resource:'Staff', details:'Removed inactive staff record', severity:'Warning' },
    { id:'AUDIT-13', ts:'2026-06-30 16:45:32', user:'Dr. Lisa Wang', action:'Login', resource:'System', details:'First login after account activation', severity:'Info' },
    { id:'AUDIT-14', ts:'2026-06-30 09:00:00', user:'System', action:'Error', resource:'Email', details:'SMTP connection timeout', severity:'Error' },
    { id:'AUDIT-15', ts:'2026-06-29 12:30:00', user:'Admin', action:'Export', resource:'Reports', details:'Exported Patient Summary (CSV)', severity:'Info' },
    { id:'AUDIT-16', ts:'2026-06-29 08:00:00', user:'System', action:'Backup', resource:'Database', details:'Weekly full backup completed (8.4 GB)', severity:'Info' },
    { id:'AUDIT-17', ts:'2026-06-28 15:15:15', user:'Dr. Mark Thompson', action:'Update', resource:'Schedule', details:'Blocked 2 slots for emergency', severity:'Info' },
    { id:'AUDIT-18', ts:'2026-06-28 11:11:11', user:'Admin', action:'Login', resource:'System', details:'Successful login from admin console', severity:'Info' },
    { id:'AUDIT-19', ts:'2026-06-27 09:30:00', user:'System', action:'Error', resource:'EMR Sync', details:'Connection lost — reconnected after 30s', severity:'Warning' },
    { id:'AUDIT-20', ts:'2026-06-27 07:45:00', user:'HR Dept', action:'Create', resource:'Staff', details:'Added new staff record — Dr. James Wilson', severity:'Info' }
  ];
  ...
  StorageDB.getAdminCredentials = function() {
    ...
    var creds = { username: 'admin_root', password: 'Admin@123' };
